...
public class PivotSlice extends JFrame{
	...
	private static final int frameWidth = 1280, frameHeight = 960; //1280x960
	...
	public JPanel northwest = new JPanel();
	public JPanel northPanel;
	public JPanel eastPanel;
	public JPanel southeast = new JPanel();
	...
	public static JLabel test = new JLabel(str);
	public static JLabel helpStr = new JLabel(str);
	...
	public PivotSlice(boolean logging) {
		...
		infoScroll.setPreferredSize(new Dimension(200, 600));
		infoScroll.setBorder(BorderFactory.createTitledBorder("Information"));
		infoScroll.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
		infoScroll.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED);
		
		final UDPReceive udp = new UDPReceive(this);
		udp.start();
/////////////////////////////////////////////////////////////////////////////////////////////////////////		
		eastPanel = new JPanel(new BorderLayout());
		eastPanel.add(infoScroll, BorderLayout.NORTH);
		eastPanel.add(test, BorderLayout.CENTER);
		
		dialog = new JDialog(SwingUtilities.windowForComponent(this));
		dialog.setPreferredSize(new Dimension(200,100));
		dialog.setUndecorated(true);
		dialog.add(helpStr, BorderLayout.PAGE_START);
		//dialog.add(f);
		dialog.pack();
//////////////////////////////////////////////////////////////////////////////////////////////////////////				
		TaskPanel taskPanel = new TaskPanel(this);
		northPanel = new JPanel(new BorderLayout());
		northPanel.add(taskPanel.getPanel(), BorderLayout.CENTER);
